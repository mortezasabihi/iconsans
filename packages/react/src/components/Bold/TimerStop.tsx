...
const SvgTimerStop = (
  ...
  >
    <path
      fill="currentColor"
      d="M16.5 14.8a3.5 3.5 0 1 0 0 7 3.5 3.5 0 0 0 0-7Zm-.23 4.9a.75.75 0 1 1-1.5 0v-2.8a.75.75 0 0 1 1.5 0v2.8Zm2 0a.75.75 0 1 1-1.5 0v-2.8a.75.75 0 0 1 1.5 0v2.8Z"
    />
    <path
      fill="currentColor"
