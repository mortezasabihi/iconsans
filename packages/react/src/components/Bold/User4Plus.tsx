...
const SvgUser4Plus = (
  ...
  >
    ...
    <path
      fill="currentColor"
      d="M16.87 13.68a3.5 3.5 0 1 0 3.5 3.5 3.491 3.491 0 0 0-3.5-3.5Zm1.5 4.25h-.75v.75a.75.75 0 1 1-1.5 0v-.75h-.75a.75.75 0 1 1 0-1.5h.75v-.75a.75.75 0 1 1 1.5 0v.75h.75a.75.75 0 1 1 0 1.5Z"
    />
  </svg>
);
