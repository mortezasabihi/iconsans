...
const SvgFingerprint = (
  ...
  >
    <g
      ...
      strokeWidth={1.5}
    >
      <path d="M9 5.33a6.2 6.2 0 0 1 10.13 4.79 14.15 14.15 0 0 1-4.07 10M4.88 12a1.85 1.85 0 0 0 1.85-1.86c0-.73.129-1.455.38-2.14M13 17.75A11.45 11.45 0 0 1 10 20" />
