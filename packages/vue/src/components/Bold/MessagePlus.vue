<template>
  ...
  >
    ...
    <path
      fill="currentColor"
      d="M19.3 3a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5Zm.83 2.94h-.39v.39a.44.44 0 1 1-.88 0v-.39h-.39a.44.44 0 0 1 0-.88h.39v-.39a.44.44 0 0 1 .88 0v.39h.39a.44.44 0 1 1 0 .88Z"
    />
  </svg>
</template>
