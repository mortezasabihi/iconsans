<template>
  ...
  >
    ...
    <path
      fill="currentColor"
      d="M21.29 6.83v6.29a2.52 2.52 0 0 1-2.16 2.5.3.3 0 0 1-.33-.31v-6a2.52 2.52 0 0 0-2.52-2.51h-9.2a.29.29 0 0 1-.3-.33 2.5 2.5 0 0 1 2.48-2.15h9.52a2.51 2.51 0 0 1 2.51 2.51Z"
    />
  </svg>
</template>
